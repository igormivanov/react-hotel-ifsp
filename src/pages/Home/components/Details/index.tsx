...
import { DetailsButtonGroup, DetailsContainer, DetailsLink } from "./styles";
  ...
  return (
    <DetailsContainer id="details">
      <div className='container'>
        ...
        <DetailsButtonGroup>
          <DetailsLink to="/">Saiba mais</DetailsLink> 
          <DetailsLink to="/booking">Reserve agora</DetailsLink>
        </DetailsButtonGroup>
      </div>
    </DetailsContainer>
  )
